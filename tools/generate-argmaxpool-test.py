...
XNN_TEST_ARGMAXPOOL_CHANNELS_EQ_UNIPASS(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
XNN_TEST_ARGMAXPOOL_CHANNELS_DIV_UNIPASS(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
XNN_TEST_ARGMAXPOOL_CHANNELS_LT_UNIPASS(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
XNN_TEST_ARGMAXPOOL_CHANNELS_GT_UNIPASS(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
...
XNN_TEST_ARGMAXPOOL_FEW_OUTPUT_PIXELS_WITH_INPUT_OFFSET(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
XNN_TEST_ARGMAXPOOL_FEW_OUTPUT_PIXELS_WITH_OUTPUT_STRIDE(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
XNN_TEST_ARGMAXPOOL_FEW_OUTPUT_PIXELS_WITH_STEP(ukernel,arch_flags, ${", ".join(TEST_ARGS)});
"""
...
""".format(specification=options.ukernel, generator=sys.argv[0])
  ...
  test_args.append("channel_scaled_tile")
