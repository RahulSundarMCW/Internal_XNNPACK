...
#define XNN_TEST_IBILINEAR_CHANNELS_EQ(ukernel, arch_flags, channel_tile, pixel_tile, ...)                             \
  TEST(ukernel, channels_eq)                                                                                           \
  {                                                                                                                    \
    IBilinearMicrokernelTester().pixels(pixel_tile).channels(channel_tile).Test(ukernel);                              \
  }
#define XNN_TEST_IBILINEAR_CHANNELS_DIV(ukernel, arch_flags, channel_tile, pixel_tile, ...)                            \
...
#define XNN_TEST_IBILINEAR_CHANNELS_LT(ukernel, arch_flags, channel_tile, pixel_tile, ...)                             \
...
#define XNN_TEST_IBILINEAR_CHANNELS_GT(ukernel, arch_flags, channel_tile, pixel_tile, ...)                             \
...
#define XNN_TEST_IBILINEAR_PIXELS_DIV(ukernel, arch_flags, channel_tile, pixel_tile, ...)                              \
...
#define XNN_TEST_IBILINEAR_PIXELS_LT(ukernel, arch_flags, channel_tile, pixel_tile, ...)                               \
...
#define XNN_TEST_IBILINEAR_PIXELS_GT(ukernel, arch_flags, channel_tile, pixel_tile, ...)                               \
...
#define XNN_TEST_IBILINEAR_INPUT_OFFSET(ukernel, arch_flags, channel_tile, pixel_tile, ...)                            \
...
#define XNN_TEST_IBILINEAR_OUTPUT_STRIDE(ukernel, arch_flags, channel_tile, pixel_tile, ...)                           \
