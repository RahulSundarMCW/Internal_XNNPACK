...
//   Microkernel: qs8-qc8w-igemm-minmax-fp32
...
std::vector<GemmTestParams> CreateTests(
  ...
  size_t nr_scale = get_batch_scale<int8_t>();
  if (nr_scale != 0) {
    nr = nr * nr_scale;
  }
...
INSTANTIATE_TEST_SUITE_P(                                                                                        \
    ...
    testing::ValuesIn(CreateTests(                                                                               \
        ...
        [](GemmMicrokernelTester& tester) {                                                                      \
          ...
          CallTestWithValidArgs(tester, (ukernel, init_params, pack_fn, packed_stride, xnn_qs8_requantize_fp32));\
        })),                                                                                                     \
