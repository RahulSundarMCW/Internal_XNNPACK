...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f16_conv_hwc2chw_ukernel_3x3s2p1c3x4__neonfp16arith_2x2, 3, 2, 1, 1, 3, 4, 4, xnn_float16, struct xnn_f16_default_params, xnn_init_f16_minmax_scalar_params)
