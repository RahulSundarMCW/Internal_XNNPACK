...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_ibilinear_chw_ukernel__neonfma_p4, 4, 1, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_ibilinear_chw_ukernel__neonfma_p8, 8, 1, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_arm_neon, xnn_f32_ibilinear_chw_ukernel__neonfma_p8, 16, 1, float, struct xnn_f32_default_params, NULL)
#endif  // XNN_ARCH_ARM || XNN_ARCH_ARM64

#if XNN_ARCH_X86 || XNN_ARCH_X86_64
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_sse, xnn_f32_ibilinear_chw_ukernel__sse_p4, 4, 1, float, struct xnn_f32_default_params, NULL)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_sse, xnn_f32_ibilinear_chw_ukernel__sse_p8, 8, 1, float, struct xnn_f32_default_params, NULL)
