...
tools/generate-gemm-test.py --ukernel bf16-gemm-minmax --output-test test/bf16-gemm-minmax.cc &
...
tools/generate-gemm-test.py --ukernel f32-qc8w-gemm        --output-test test/f32-qc8w-gemm.cc        &
